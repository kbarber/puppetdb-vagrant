...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "centos-7.0-64-nocm" do |vm|
    vm.vm.box = "puppetlabs/centos-7.0-64-nocm"
  end
  config.vm.define "debian-7.8-64-nocm" do |vm|
    vm.vm.box = "puppetlabs/debian-7.8-64-nocm"
  end
